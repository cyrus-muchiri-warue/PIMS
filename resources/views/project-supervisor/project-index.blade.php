            ...
            <tr>
                ...
                <td>
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <img alt="Avatar" class="table-avatar" src="/vendor/dist/img/avatar.png">
                        </li>
                        <li class="list-inline-item">
                            <img alt="Avatar" class="table-avatar" src="/vendor/dist/img/avatar2.png">
                        </li>
                        <li class="list-inline-item">
                            <img alt="Avatar" class="table-avatar" src="/vendor/dist/img/avatar3.png">
                        </li>
                        <li class="list-inline-item">
                            <img alt="Avatar" class="table-avatar" src="/vendor/dist/img/avatar4.png">
                        </li>
                    </ul>
                </td>
                <td>
              ...
              <i class="far fa-comments"></i>
                ...
                <td class="project-actions text-right">
                    <a class="btn btn-primary btn-sm" href="{{route('project.show')}}">
            ...
            <tr>
                ...
                <td>
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item">
                            <img alt="Avatar" class="table-avatar" src="/vendor/dist/img/avatar5.png">
                        </li>
                    </ul>
                </td>
                <td>
